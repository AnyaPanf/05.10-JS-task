...
//      return acc = acc + ' ' + rec // не приравниваем (асс) к результату, а просто возаращаем результат // Не сразу понял зачем нужны вторые ковычки, оказывается для пробела) Возьмите в привычку использовать инторполяцию она нам очень пригодится 
// }, " ")
// }
...
// const getSym = (arr) => {
//     return arr.reduce((acc,rec) => {
//         return acc = acc + rec.length // не приравниваем (асс) к результату, а просто возаращаем результат
//     }, 0)
// }
...
const getNum = (arr) => {
    ...
    return arr.filter((el) => {
        ...
        return acc =[...acc,rec]   // не приравниваем (асс) к результату, а просто возаращаем результат
    },[])
}
